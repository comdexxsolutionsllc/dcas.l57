  ...
  <div class="col-md-10">
    <select class="form-control" id="account_id" name="account_id" required="true">
      <option value="" style="display: none;"
              {{ old('account_id', optional($whiteGlove)->account_id ?: '') == '' ? 'selected' : '' }} disabled
              selected>Enter account here...
      </option>
      @foreach ($accounts as $key => $account)
        <option value="{{ $key }}" {{ old('account_id', optional($whiteGlove)->account_id) == $key ? 'selected' : '' }}>
          {{ $account }}
        </option>
      @endforeach
    </select>
...
<div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <input class="form-control" name="name" type="text" id="name"
           value="{{ old('name', optional($whiteGlove)->name) }}" minlength="1" maxlength="255" required="true"
...
<div class="form-group {{ $errors->has('username') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <input class="form-control" name="username" type="text" id="username"
           value="{{ old('username', optional($whiteGlove)->username) }}" minlength="1" maxlength="255"
...
<div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <input class="form-control" name="email" type="text" id="email"
           value="{{ old('email', optional($whiteGlove)->email) }}" minlength="1" maxlength="255" required="true"
...
<div class="form-group {{ $errors->has('email_verified_at') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <input class="form-control" name="email_verified_at" type="text" id="email_verified_at"
           value="{{ old('email_verified_at', optional($whiteGlove)->email_verified_at) }}"
...
<div class="form-group {{ $errors->has('password') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <input class="form-control" name="password" type="text" id="password"
           value="{{ old('password', optional($whiteGlove)->password) }}" minlength="1" maxlength="255"
...
<div class="form-group {{ $errors->has('stripe_id') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <select class="form-control" id="stripe_id" name="stripe_id">
      <option value="" style="display: none;"
              {{ old('stripe_id', optional($whiteGlove)->stripe_id ?: '') == '' ? 'selected' : '' }} disabled
              selected>Select stripe
      </option>
      @foreach ($stripes as $key => $stripe)
        <option value="{{ $key }}" {{ old('stripe_id', optional($whiteGlove)->stripe_id) == $key ? 'selected' : '' }}>
          {{ $stripe }}
        </option>
      @endforeach
    </select>
...
<div class="form-group {{ $errors->has('card_brand') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <input class="form-control" name="card_brand" type="text" id="card_brand"
           value="{{ old('card_brand', optional($whiteGlove)->card_brand) }}" maxlength="255"
...
<div class="form-group {{ $errors->has('card_last_four') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <input class="form-control" name="card_last_four" type="text" id="card_last_four"
           value="{{ old('card_last_four', optional($whiteGlove)->card_last_four) }}" maxlength="255"
...
<div class="form-group {{ $errors->has('trial_ends_at') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <input class="form-control" name="trial_ends_at" type="text" id="trial_ends_at"
           value="{{ old('trial_ends_at', optional($whiteGlove)->trial_ends_at) }}"
...
<div class="form-group {{ $errors->has('cover') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <input class="form-control" name="cover" type="text" id="cover"
           value="{{ old('cover', optional($whiteGlove)->cover) }}" maxlength="255"
           placeholder="Enter cover here...">
...
<div class="form-group {{ $errors->has('avatar') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <input class="form-control" name="avatar" type="text" id="avatar"
           value="{{ old('avatar', optional($whiteGlove)->avatar) }}" maxlength="255">
...
<div class="form-group {{ $errors->has('remember_token') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <input class="form-control" name="remember_token" type="text" id="remember_token"
           value="{{ old('remember_token', optional($whiteGlove)->remember_token) }}" maxlength="100"
