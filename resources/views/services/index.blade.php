        ...
        <div class="table-responsive">
          ...
          <table class="table table-striped ">
            ...
            @foreach($services as $service)
              <tr>
                <td>{{ optional($service->account)->id }}</td>
                <td>{{ $service->service_type }}</td>
                <td>{{ $service->status }}</td>
                <td>{{ $service->last_payment }}</td>
                <td>{{ $service->last_invoice }}</td>
                ...
                <td>
                  ...
                  <form method="POST" action="{!! route('services.service.destroy', $service->id) !!}"
                    ...
                    <div class="btn-group btn-group-xs pull-right" role="group">
                      <a href="{{ route('services.service.show', $service->id ) }}"
                         class="btn btn-info" title="Show Service">
                        <span class="glyphicon glyphicon-open" aria-hidden="true"></span>
                      </a>
                      <a href="{{ route('services.service.edit', $service->id ) }}"
