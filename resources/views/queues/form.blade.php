<div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <input class="form-control" name="name" type="text" id="name" value="{{ old('name', optional($queue)->name) }}"
...
<div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
        <textarea class="form-control" name="description" cols="50" rows="10"
                  id="description">{{ old('description', optional($queue)->description) }}</textarea>
    ...
    <div class="checkbox">
      <label for="visible_1">
        <input id="visible_1" class="" name="visible" type="checkbox"
               value="1" {{ old('visible', optional($queue)->visible) == '1' ? 'checked' : '' }}>
        Yes
      </label>
    </div>
