...
@section('content')
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-heading clearfix">
      ...
      <div class="pull-left">
        <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : 'Invoice Item' }}</h4>
      </div>
    ...
    <div class="panel-body">
      ...
      <form method="POST" action="{{ route('invoice_items.invoice_item.update', $invoiceItem->id) }}"
            id="edit_invoice_item_form" name="edit_invoice_item_form" accept-charset="UTF-8"
