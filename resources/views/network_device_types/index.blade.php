...
@section('content')
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-heading clearfix">
      ...
      <div class="pull-left">
        <h4 class="mt-5 mb-5">Network Device Types</h4>
      </div>
    ...
    @if(count($networkDeviceTypes) == 0)
      <div class="panel-body text-center">
        <h4>No Network Device Types Available!</h4>
      </div>
    @else
      <div class="panel-body panel-body-with-table">
        <div class="table-responsive">
          ...
          <table class="table table-striped ">
            ...
            <tbody>
            @foreach($networkDeviceTypes as $networkDeviceType)
              <tr>
                <td>{{ $networkDeviceType->name }}</td>
                ...
                <td>
                  ...
                  <form method="POST"
                    ...
                    <div class="btn-group btn-group-xs pull-right" role="group">
                      <a href="{{ route('network_device_types.network_device_type.show', $networkDeviceType->id ) }}"
                         class="btn btn-info" title="Show Network Device Type">
                      ...
                      <button type="submit" class="btn btn-danger"
                              title="Delete Network Device Type"
