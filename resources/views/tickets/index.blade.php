                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-striped ">
                        ...
                        @foreach($tickets as $ticket)
                            <tr>
                                <td>{{ optional($ticket->ticket)->id }}</td>
                                <td>{{ $ticket->title }}</td>
                                ...
                                <td>
                                    ...
                                    <form method="POST" action="{!! route('tickets.ticket.destroy', $ticket->id) !!}"
                                        ...
                                        <div class="btn-group btn-group-xs pull-right" role="group">
                                            <a href="{{ route('tickets.ticket.show', $ticket->id ) }}"
                                               class="btn btn-info" title="Show Ticket">
                                                <span class="glyphicon glyphicon-open" aria-hidden="true"></span>
                                            </a>
                                            <a href="{{ route('tickets.ticket.edit', $ticket->id ) }}"
                                               class="btn btn-primary" title="Edit Ticket">
