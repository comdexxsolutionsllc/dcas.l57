...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Notifications</h4>
            </div>
                        ...
                        @foreach($notifications as $notification)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="POST"
                                          action="{!! route('notifications.notification.destroy', $notification->id) !!}"
                                          accept-charset="UTF-8">
                                        <input name="_method" value="DELETE" type="hidden">
                                        {{ csrf_field() }}

                                        <div class="btn-group btn-group-xs pull-right" role="group">
                                            <a href="{{ route('notifications.notification.show', $notification->id ) }}"
                                               class="btn btn-info" title="Show Notification">
