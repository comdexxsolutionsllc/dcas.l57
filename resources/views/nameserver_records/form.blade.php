  ...
  <div class="col-md-10">
    <select class="form-control" id="domain_id" name="domain_id" required="true">
      <option value="" style="display: none;"
              {{ old('domain_id', optional($nameserverRecord)->domain_id ?: '') == '' ? 'selected' : '' }} disabled
              selected>Select domain
      </option>
      @foreach ($domains as $key => $domain)
        <option
          value="{{ $key }}" {{ old('domain_id', optional($nameserverRecord)->domain_id) == $key ? 'selected' : '' }}>
          {{ $domain }}
        </option>
      @endforeach
    </select>
...
<div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <input class="form-control" name="name" type="text" id="name"
           value="{{ old('name', optional($nameserverRecord)->name) }}" maxlength="255"
...
<div class="form-group {{ $errors->has('type') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <input class="form-control" name="type" type="text" id="type"
           value="{{ old('type', optional($nameserverRecord)->type) }}" maxlength="255"
...
<div class="form-group {{ $errors->has('content') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <input class="form-control" name="content" type="text" id="content"
           value="{{ old('content', optional($nameserverRecord)->content) }}" maxlength="255"
...
<div class="form-group {{ $errors->has('ttl') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <input class="form-control" name="ttl" type="number" id="ttl"
           value="{{ old('ttl', optional($nameserverRecord)->ttl) }}" min="-2147483648" max="2147483647"
           placeholder="Enter ttl here...">
...
<div class="form-group {{ $errors->has('priority') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <input class="form-control" name="priority" type="number" id="priority"
           value="{{ old('priority', optional($nameserverRecord)->priority) }}" min="-2147483648" max="2147483647"
...
<div class="form-group {{ $errors->has('change_date') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <input class="form-control" name="change_date" type="number" id="change_date"
           value="{{ old('change_date', optional($nameserverRecord)->change_date) }}" min="-2147483648"
           max="2147483647" placeholder="Enter change date here...">
...
<div class="form-group {{ $errors->has('disabled') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <input class="form-control" name="disabled" type="text" id="disabled"
           value="{{ old('disabled', optional($nameserverRecord)->disabled) }}" minlength="1" required="true"
...
<div class="form-group {{ $errors->has('ordername') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <input class="form-control" name="ordername" type="text" id="ordername"
           value="{{ old('ordername', optional($nameserverRecord)->ordername) }}" maxlength="255"
...
<div class="form-group {{ $errors->has('auth') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <input class="form-control" name="auth" type="text" id="auth"
           value="{{ old('auth', optional($nameserverRecord)->auth) }}" minlength="1" required="true"
           placeholder="Enter auth here...">
