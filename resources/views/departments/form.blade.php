<div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="name" type="text" id="name"
               value="{{ old('name', optional($department)->name) }}" minlength="1" maxlength="255" required="true"
...
<div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <textarea class="form-control" name="description" cols="50" rows="10"
                  id="description">{{ old('description', optional($department)->description) }}</textarea>
...
<div class="form-group {{ $errors->has('hexcode') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="hexcode" type="text" id="hexcode"
               value="{{ old('hexcode', optional($department)->hexcode) }}" minlength="1" maxlength="255"
               required="true" placeholder="Enter hexcode here...">
        ...
        <div class="checkbox">
            <label for="visible_1">
                <input id="visible_1" class="" name="visible" type="checkbox"
                       value="1" {{ old('visible', optional($department)->visible) == '1' ? 'checked' : '' }}>
                Yes
            </label>
        </div>
