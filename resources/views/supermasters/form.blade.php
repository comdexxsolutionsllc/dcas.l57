<div class="form-group {{ $errors->has('ip') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <input class="form-control" name="ip" type="text" id="ip" value="{{ old('ip', optional($supermaster)->ip) }}"
           minlength="1" maxlength="45" required="true" placeholder="Enter ip here...">
...
<div class="form-group {{ $errors->has('nameserver') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <input class="form-control" name="nameserver" type="text" id="nameserver"
           value="{{ old('nameserver', optional($supermaster)->nameserver) }}" minlength="1" maxlength="255"
           required="true" placeholder="Enter nameserver here...">
...
<div class="form-group {{ $errors->has('account') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <input class="form-control" name="account" type="text" id="account"
           value="{{ old('account', optional($supermaster)->account) }}" min="1" max="255" required="true"
