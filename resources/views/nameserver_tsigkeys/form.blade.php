<div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <input class="form-control" name="name" type="text" id="name"
           value="{{ old('name', optional($nameserverTsigkey)->name) }}" minlength="1" maxlength="255"
...
<div class="form-group {{ $errors->has('algorithm') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <input class="form-control" name="algorithm" type="text" id="algorithm"
           value="{{ old('algorithm', optional($nameserverTsigkey)->algorithm) }}" minlength="1" maxlength="255"
...
<div class="form-group {{ $errors->has('secret') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <input class="form-control" name="secret" type="text" id="secret"
           value="{{ old('secret', optional($nameserverTsigkey)->secret) }}" minlength="1" maxlength="255"
           required="true" placeholder="Enter secret here...">
